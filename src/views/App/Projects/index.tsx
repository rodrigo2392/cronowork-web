...
import {useGetProjects, useDeleteProject} from '../../../services/projects.service';
...
const columns = columnDefinition({ deleteFunction, editFunction });
  return (
    <AppLayout>
      <Box sx={{mb:4, ml: 2}}>
        <CreateModal id={editId} edit={!!editId} refetch={refetch} visible={showCreateModal} setVisible={setCreateModal} />
        ...
        <GenericTable
            ...
            labels={labels}
            columns={columns as []}
            changeRowPerPage={() => console.log("change") as unknown as UnknownAction}
